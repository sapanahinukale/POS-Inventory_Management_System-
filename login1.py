...
class Login_System:
    def __init__(self,root): 
          ...
          self.bg=ImageTk.PhotoImage(file='images/background1.png')
         ...
         #===Login_Frame=======
          ...
          btn_forget=Button(login_frame,text="Forget Pssword?",command=self.forget_window,font=("times new roman",13),bg="white",fg="#00759E",bd=0,activebackground="white",activeforeground="#00759E").place(x=100,y=390)
            ...
            if self.employee_id.get()=="":
                ...
                if email==None:
                    ...
                    if chk=='f':
                      ...
                      self.btn_reset=Button(self.forget_win,text="SUBMIT",command=self.validate_otp,font=("times new roman",15),bg='lightyellow')
                      ...
                      c_pass=Label(self.forget_win,text="Confirm Password",font=("times new roman",15)).place(x=20,y=225)
                      ...
                      self.btn_update=Button(self.forget_win,text="Update",command=self.update_password,state=DISABLED,font=("times new roman",15),bg='lightyellow')
