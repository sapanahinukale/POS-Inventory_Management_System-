...
class Billclass:
    def __init__(self,root):
        ...
        btn_clear_cart=Button(Add_CartWidgetsFrame,text="Clear",command=self.clear_all,font=("times new roman",15,"bold"),bg="lightgray",cursor="hand2").place(x=180,y=70,width=150,height=30)
        ...
        BTitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="blue",fg="white").pack(side=TOP,fill=X)
        ...
        #=========Footer============
        footer=Label(self.root,text="POS(Inventory Management System)\nFor any Technical Issue contact: 9876453665",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#================All Function===================
    ...
    def get_data(self,ev):
        ...
        self.var_qty.set('1')  #by default 1
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            fp.close()
            messagebox.showinfo('Saved',"Bill has been generatrd/Save in Backend",parent=self.root)
            self.chk_print=1
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\t(POS)-Inventory
\t Phone No. 9872564734 , Delhi-125001
{str("="*47)}
